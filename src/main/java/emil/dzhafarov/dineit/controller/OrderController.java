...
public class OrderController {
    ...
    @RequestMapping(value = "/create-order/{food_company_id}", method = RequestMethod.POST)
    public ResponseEntity<Long> createOrder(@PathVariable("food_company_id") Long foodCompanyId,
